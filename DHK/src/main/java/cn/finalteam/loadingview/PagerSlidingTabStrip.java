...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabBackgroundResId = R.drawable.background_tab;//按下时的背景颜色
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		selectedTabTextSize = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_SelectedTabTextSize,
				selectedTabTextSize);
		selectedTabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_SelectedTabTextColor, selectedTabTextColor);
