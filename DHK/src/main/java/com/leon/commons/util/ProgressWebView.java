...
import com.kym.ui.util.MyDownLoadListener;
...
public class ProgressWebView extends WebView {
    ...
    public ProgressWebView(Context context, TextView text_title, Intent intent) {
        super(context);
...
//        loading = news_img DialogUtil(context);
...
//            final DialogUtil dialogUtil = news_img DialogUtil(context);
            //作用：获得网页的加载进度并显示
            if (newProgress < 100) {
