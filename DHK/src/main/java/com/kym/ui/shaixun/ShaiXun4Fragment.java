...
public class ShaiXun4Fragment extends Fragment {
    ...
    public ShaiXun4Fragment(ShaiXunActivity shaiXunActivity, String lid, String title, String headImg) {
        this.lid = lid;
