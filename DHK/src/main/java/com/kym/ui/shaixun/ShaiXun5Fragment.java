...
public class ShaiXun5Fragment extends Fragment {
    ...
    public ShaiXun5Fragment(ShaiXunActivity shaiXunActivity, String lid, String title, String headImg) {
        this.lid = lid;
