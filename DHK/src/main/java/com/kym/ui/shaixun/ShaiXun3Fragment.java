...
public class ShaiXun3Fragment extends Fragment {
    ...
    public ShaiXun3Fragment(ShaiXunActivity shaiXunActivity, String lid, String title, String headImg) {
        this.lid = lid;
