...
public class ShouKuanDetailListActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initUI() {
        ...
        adapter_fen = new FenrundelAdapter(ShouKuanDetailListActivity.this, allhotlist_shouru);
    ...
    private void getdata(final int page) {
        ...
        Connect.getInstance().post(ShouKuanDetailListActivity.this, IService.SPLITTERLIST, params, new Connect.OnResponseListener() {
            @Override
    ...
    private void test() {
        new DoubleDatePickerDialog(ShouKuanDetailListActivity.this, 0, new DoubleDatePickerDialog.OnDateSetListener() {
            @SuppressLint("DefaultLocale")
            @Override
