...
//                startActivity(intent);
                ...
                intent.putExtra("WEB_TITLE", "信用卡智收");
                intent.putExtra("WEB_URL", Clone.HOST+"Bpbro_Sun/view/bpbro_skyk/bpbro_sk_pass.html?bank_name=" + kuaiJieCardListInfo.getBank_name() +
    ...
    private void getSK_bank_list() {
        ...
        Connect.getInstance().post(getApplicationContext(), IService.XF_BANK_LIST, null, new Connect.OnResponseListener() {
            @Override
            public void onSuccess(Object result) {
                ...
                if (response.getResult().getCode() == 10000) {
                    ...
                    backDialog = new BackDialog("", "登录过期,请重新登录", "确定", XiaoFeiActivity.this,
