...
public class FanXianzhActivity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fan_xianzh);
        initview();
    }

    private void getdata() {
        loadDialogUti = new DialogUtil(this);
        Connect.getInstance().post(FanXianzhActivity.this, IService.GET_ACCOUNT_BALANCE, null, new Connect.OnResponseListener() {
            @Override
            public void onSuccess(Object result) {
                ...
                if (response.getResult().getCode() == 10000) {
                    ...
                    int todayMoney = response.getData().getTodaybackMoney();
                    int yesterdayMoney = response.getData().getYesterdaybackMoney();
                    int total_money = response.getData().getTotalback_money();
                    try {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.lay_yue_tx:
                Intent intent5 = new Intent(FanXianzhActivity.this, FanXianTiXianActivity.class);
