...
public class HK_planinfoActivity extends BaseActivity {
        ...
        Connect.getInstance().post(getApplicationContext(), IService.HK_LIST, paramx, new Connect.OnResponseListener() {
            ...
            public void onSuccess(Object result) {
                ...
                if (response.getResult().getCode() == 10000) {
                    ...
                    backDialog = new BackDialog("", "登录过期,请重新登录", "确定", HK_planinfoActivity.this,
                            R.style.Theme_Dialog_Scale, new BackDialog.DialogClickListener() {
                        @Override
                        public void onClick(View view) {
                            startActivity(new Intent(HK_planinfoActivity.this, LoginActivity.class));
