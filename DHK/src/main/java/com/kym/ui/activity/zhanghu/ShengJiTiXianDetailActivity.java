 ...
 * @date 2019/12/3
 */
public class ShengJiTiXianDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userAllInfoNew = SPConfig.getInstance(ShengJiTiXianDetailActivity.this).getUserAllInfoNew();
        initUI();
        getdata(1);
    ...
    private void dialog_one(String bank, String acont, String addtime) {
        dialog_tt = new Dialog(ShengJiTiXianDetailActivity.this, R.style.MyDialgoStyle_xin_x);
    ...
    private void initUI() {
        ...
        adapter_fen = new TiXianAdapter(
                ShengJiTiXianDetailActivity.this
                , allhotlist_shouru);
    ...
    private void getdata(final int page) {
        ...
        Loading = new DialogUtil(ShengJiTiXianDetailActivity.this);
        HashMap<String, String> params = new HashMap<>();
        params.put("p", page + "");
        Connect.getInstance().post(ShengJiTiXianDetailActivity.this, IService.SHENJILIST, params, new Connect.OnResponseListener() {
            @Override
    ...
    private void test() {
        new DoubleDatePickerDialog(ShengJiTiXianDetailActivity.this, 0,
