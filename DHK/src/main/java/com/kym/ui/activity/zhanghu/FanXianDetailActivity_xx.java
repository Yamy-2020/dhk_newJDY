...
public class FanXianDetailActivity_xx extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fen_run_detail);
        initUI();
        initHead();
        getdata(mPage);
    }
    ...
    private void initUI() {
        ...
        adapter_fen = new FenrundelAdapter(FanXianDetailActivity_xx.this, allhotlist_shouru);
    ...
    private void initHead() {
        ...
        TextView img_right = (TextView) findViewById(R.id.head_img_right);
    ...
    private void getdata(final int page) {
        {
            loadDialogUtil = new DialogUtil(FanXianDetailActivity_xx.this);
            HashMap<String, String> params = new HashMap<>();
            params.put("p", page + "");
            params.put("type", type);
            params.put("starttime", s_sat);
            params.put("endtime", s_end);
            Connect.getInstance().post(FanXianDetailActivity_xx.this, IService.SPLITTER_BACKLIST, params, new Connect.OnResponseListener() {
                @Override
                public void onSuccess(Object result) {
                    ...
                    if (response.getResult().getCode() == 10000) {
                        ...
                        mPtrLayout.onRefreshComplete();
                        mLv.onLoadMoreComplete();
                        ToastUtil.showTextToas(getApplicationContext(), "当前没有更多数据可以加载");
                    }
    ...
    private void test() {
        new DoubleDatePickerDialog(FanXianDetailActivity_xx.this, 0, new DoubleDatePickerDialog.OnDateSetListener() {
            @SuppressLint("DefaultLocale")
            @Override
