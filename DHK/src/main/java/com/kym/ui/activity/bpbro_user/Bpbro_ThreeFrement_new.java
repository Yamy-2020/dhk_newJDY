package com.kym.ui.activity.bpbro_user;
...
public class Bpbro_ThreeFrement_new extends Fragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if (layout == null) {
            layout = inflater.inflate(R.layout.bpbro_user, null);
        }
    ...
    private void initView() {
        ...
        layout.findViewById(R.id.user_bankcard).setOnClickListener(this);
