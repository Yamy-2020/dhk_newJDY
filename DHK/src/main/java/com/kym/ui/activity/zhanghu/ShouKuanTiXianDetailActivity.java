...
public class ShouKuanTiXianDetailActivity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userAllInfoNew = SPConfig.getInstance(ShouKuanTiXianDetailActivity.this).getUserAllInfoNew();
        initUI();
        getdata(1);
    ...
    private void dialog_one(String bank, String acont, String addtime) {
        dialog_tt = new Dialog(ShouKuanTiXianDetailActivity.this, R.style.MyDialgoStyle_xin_x);
    ...
    private void initUI() {
       ...
       /* adapter_fen = new TiXianAdapter(
                ShouKuanTiXianDetailActivity.this
                , allhotlist_shouru);*/
    ...
    private void getdata(final int page) {
        ...
        Loading = new DialogUtil(ShouKuanTiXianDetailActivity.this);
        HashMap<String, String> params = new HashMap<>();
        params.put("p", page + "");
        Connect.getInstance().post(ShouKuanTiXianDetailActivity.this, IService.SHOUKUAN_CASH_BACKLSIT, params, new Connect.OnResponseListener() {
            @Override
    ...
    private void test() {
        new DoubleDatePickerDialog(ShouKuanTiXianDetailActivity.this, 0,
