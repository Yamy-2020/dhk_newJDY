...
/**
 * 折线图
 * Created by SunMiaoLong on 16/4/7.
 */
public class LineChartView extends View implements View.OnTouchListener {
    ...
    private class Surface {
        ...
        public int titleColor = getResources().getColor(R.color.black_33);
        public int lineColor = getResources().getColor(R.color.jiugongge);
        public int textColor = Color.WHITE;
        public int pointColor = lineColor;
        public int axisXColor = getResources().getColor(R.color.jiugongge);
        public int gridColor = getResources().getColor(R.color.yellow);
