 ...
 * @date 2019/12/3
 */
public class HuoDongTiXianDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sheng_ji_ti_xian_detail);
        userAllInfoNew = SPConfig.getInstance(HuoDongTiXianDetailActivity.this).getUserAllInfoNew();
        initUI();
        getdata(1);
        ...
        ImageView imageV_right = (ImageView) findViewById(R.id.head_img_right);
    ...
    private void dialog_one(String bank, String acont, String addtime) {
        dialog_tt = new Dialog(HuoDongTiXianDetailActivity.this, R.style.MyDialgoStyle_xin_x);
    ...
    private void getdata(final int page) {
        ...
        Loading = new DialogUtil(HuoDongTiXianDetailActivity.this);
        HashMap<String, String> params = new HashMap<>();
        params.put("p", page + "");
        Connect.getInstance().post(HuoDongTiXianDetailActivity.this, IService.HUODONGLIST, params, new Connect.OnResponseListener() {
            @Override
    ...
    private void test() {
        new DoubleDatePickerDialog(HuoDongTiXianDetailActivity.this, 0,
