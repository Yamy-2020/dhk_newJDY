...
public class New_DaiChang_Li6_1Fragment extends Fragment {
    ...
    public New_DaiChang_Li6_1Fragment(New_DaiChang_Li6_Activity recordActivity) {
    ...
    private void getAllPlanList() {
        ...
        Connect.getInstance().post(getActivity(), IService.HUANKUANLIST, null, new Connect.OnResponseListener() {
            @Override
