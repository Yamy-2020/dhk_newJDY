...
public class DaiChangPlanRecord3Fragment extends Fragment {
    ...
    public DaiChangPlanRecord3Fragment(DaiChangPlanRecordActivity recordActivity) {
                ...
                if (response.getResult().getCode() == 10000) {
                    if (response.getData() != null) {
                        ...
                        if (mPage == 1) {
                            ...
                            Toast.makeText(getActivity(), "当前没有更多数据可以加载", Toast.LENGTH_SHORT).show();
                        }
                    };
