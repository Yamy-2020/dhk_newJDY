 ...
 * @date 2019/12/3
 */
public class DaiChangTiXianDetailActivity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userAllInfoNew = SPConfig.getInstance(DaiChangTiXianDetailActivity.this).getUserAllInfoNew();
        initUI();
        getdata(1);
    ...
    private void dialog_one(String bank, String acont, String addtime) {
        dialog_tt = new Dialog(DaiChangTiXianDetailActivity.this, R.style.MyDialgoStyle_xin_x);
    ...
    private void getdata(final int page) {
        ...
        Loading = new DialogUtil(DaiChangTiXianDetailActivity.this);
        HashMap<String, String> params = new HashMap<>();
        params.put("p", page + "");
        Connect.getInstance().post(DaiChangTiXianDetailActivity.this, IService.DAICHANG_TIXIAN_JILU, params, new Connect.OnResponseListener() {
            @Override
    ...
    private void test() {
        new DoubleDatePickerDialog(DaiChangTiXianDetailActivity.this, 0,
