...
public class
DaiChangDetailListActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initUI() {
        ...
        adapter_fen = new FenrundelAdapter(DaiChangDetailListActivity.this, allhotlist_shouru);
    ...
    private void getdata(final int page) {
        {
            loadDialogUtil = new DialogUtil(DaiChangDetailListActivity.this);
            HashMap<String, String> params = new HashMap<>();
            params.put("p", page + "");
            params.put("type", type);
            params.put("starttime", s_sat);
            params.put("endtime", s_end);
            Connect.getInstance().post(DaiChangDetailListActivity.this, IService.SPLITTERLIST, params, new Connect.OnResponseListener() {
                @Override
    ...
    private void test() {
        new DoubleDatePickerDialog(DaiChangDetailListActivity.this, 0, new DoubleDatePickerDialog.OnDateSetListener() {
            @SuppressLint("DefaultLocale")
            @Override
