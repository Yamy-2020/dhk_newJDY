    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.lay_foot_add:
                Intent intent = new Intent(getApplicationContext(), NewAddCreditCardActivity.class);
            ...
            public void onSuccess(Object result) {
                ...
                try {
                    ...
                    if (code.equals("10000")) {
                        ...
                        backDialog = new BackDialog("", "登录过期,请重新登录", "确定", AllCardListActivity.this,
                                R.style.Theme_Dialog_Scale, new BackDialog.DialogClickListener() {
                            @Override
                            public void onClick(View view) {
                                startActivity(new Intent(AllCardListActivity.this, LoginActivity.class));
...
//                                restartApp(getApplicationContext());
    ...
    public void tipView(final String flag, String msg) {
        backDialog = new BackDialog("", msg, "确定", AllCardListActivity.this,
                R.style.Theme_Dialog_Scale, new BackDialog.DialogClickListener() {
            @Override
            public void onClick(View view) {
                if (!flag.equals("1")) {
