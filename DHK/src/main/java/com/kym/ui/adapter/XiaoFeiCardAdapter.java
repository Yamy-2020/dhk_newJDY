...
public class XiaoFeiCardAdapter extends RecyclerView.Adapter {
    private Context context;
    private XiaoFeiCardAdapter.OnDaiChangCardInfo listener;
    private ArrayList<DaiChangCardInfo.DaiChangCardData> models = new ArrayList<>();

    public XiaoFeiCardAdapter(Context context, XiaoFeiCardAdapter.OnDaiChangCardInfo listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new XiaoFeiCardAdapter.ContentViewHolder(view);
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof XiaoFeiCardAdapter.ContentViewHolder) {
            XiaoFeiCardAdapter.ContentViewHolder viewHolder = (XiaoFeiCardAdapter.ContentViewHolder) holder;
            ...
            if (model.getType().equals("1")) {
                ...
                viewHolder.dc_type.setText("到账金额");
