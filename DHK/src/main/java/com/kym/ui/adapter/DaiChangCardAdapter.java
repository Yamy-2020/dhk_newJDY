...
public class DaiChangCardAdapter extends RecyclerView.Adapter {
    private Context context;
    private DaiChangCardAdapter.OnDaiChangCardInfo listener;
    private ArrayList<DaiChangCardInfo.DaiChangCardData> models = new ArrayList<>();

    public DaiChangCardAdapter(Context context, DaiChangCardAdapter.OnDaiChangCardInfo listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new DaiChangCardAdapter.ContentViewHolder(view);
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof DaiChangCardAdapter.ContentViewHolder) {
            DaiChangCardAdapter.ContentViewHolder viewHolder = (DaiChangCardAdapter.ContentViewHolder) holder;
            ...
            if (model.getStatus().equals("1")) {
                ...
                viewHolder.dc_status.setText("执行失败");
