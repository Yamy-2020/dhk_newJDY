...
public class CameraActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_zhengjian);
...
//                                    (int) ((bottom - top) * (float) bitmap.getHeight()));
                            ...
                            final File cropFile = getOriginalFile();
    ...
    private File getOriginalFile() {
        switch (type) {
            case TYPE_IDCARD_FRONT:
                return new File(Environment.getExternalStorageDirectory(), "idCardFront.png");
            case TYPE_IDCARD_BACK:
                return new File(Environment.getExternalStorageDirectory(), "idCardBack.png");
            case TYPE_COMPANY_PORTRAIT:
            case TYPE_COMPANY_LANDSCAPE:
                return new File(Environment.getExternalStorageDirectory(), "companyInfo.png");
        }
        return new File(Environment.getExternalStorageDirectory(), "picture.png");
    }
    ...
    private File getCropFile() {
        switch (type) {
            case TYPE_IDCARD_FRONT:
                return new File(Environment.getExternalStorageDirectory(), "idCardFrontCrop.png");
            case TYPE_IDCARD_BACK:
                return new File(Environment.getExternalStorageDirectory(), "idCardBackCrop.png");
            case TYPE_COMPANY_PORTRAIT:
            case TYPE_COMPANY_LANDSCAPE:
                return new File(Environment.getExternalStorageDirectory(), "companyInfoCrop.png");
        }
        return new File(Environment.getExternalStorageDirectory(), "pictureCrop.png");
    }
    ...
    private void goBack() {
        ...
        intent.putExtra("result", getOriginalFile().getPath());
