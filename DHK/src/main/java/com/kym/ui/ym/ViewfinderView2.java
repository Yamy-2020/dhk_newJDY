...
public class ViewfinderView2 extends View{
	...
	public ViewfinderView2(Context context, AttributeSet attrs, int defStyle) {
	...
	public void initFinder(int pWidth,int pHeight,Handler mHandler){
		...
		marginT = mContext.getResources().getDimension(R.dimen.public_60_dp);
...
//		}
		...
		canvas.drawLine((lineRight - lineLeft)*0.15f+lineLeft , (lineBottom - lineTop)*0.6f+lineTop, lineRight - (lineRight - lineLeft)*0.15f, (lineBottom - lineTop)*0.6f+lineTop, paint);
