...
/**
 * Created by sunmiaolong on 2018/5/14.
 */
...
public class LockView extends View {
    ...
    private int mWidth;
    private int mHeight;
    private static final int PATTERN_SIZE_ONE = 180; //图案大小(大圆)
    private static final int PATTERN_SIZE_TWO = 50; //图案大小(小圆)
    ...
    public LockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPaint.setColor(Color.parseColor("#3b8ac2"));
    ...
    private void drawLine(Canvas canvas) {
        ...
        mPaint.setColor(getResources().getColor(R.color.blue_2e));
    ...
    private void drawPattern1(Canvas canvas) {
        for (int i = 0; i < patterns.size(); i++) {
            rectF.left = patterns.get(i).startX;
            rectF.top = patterns.get(i).startY;
            rectF.right = patterns.get(i).endX;
...
//                            onDrawFinish.twoDraw(isOk());
    ...
    public interface OnDrawFinish {
        ...
        void twoDraw(List<Integer> passwords);
