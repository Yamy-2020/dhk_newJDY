...
public class FenRunDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initUI() {
        ...
        adapter_fen = new FenrundelAdapter(FenRunDetailActivity.this, allhotlist_shouru);
    ...
    private void getdata(final int page) {
        {
            loadDialogUtil = new DialogUtil(FenRunDetailActivity.this);
            HashMap<String, String> params = new HashMap<>();
            params.put("p", page + "");
            params.put("type", type);
            params.put("starttime", s_sat);
            params.put("endtime", s_end);
            Connect.getInstance().post(FenRunDetailActivity.this, IService.SPLITTERLIST, params, new Connect.OnResponseListener() {
                @Override
    ...
    private void test() {
        new DoubleDatePickerDialog(FenRunDetailActivity.this, 0, new DoubleDatePickerDialog.OnDateSetListener() {
    ...
    public void tipView(final String flag, String msg) {
        backDialog = new BackDialog("", msg, "确定", FenRunDetailActivity.this,
