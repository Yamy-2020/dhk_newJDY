...
public class HK_Sb_planinfoActivity_ViewBinding implements Unbinder {
  private HK_Sb_planinfoActivity target;

  private View view2131296671;

  @UiThread
  public HK_Sb_planinfoActivity_ViewBinding(HK_Sb_planinfoActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public HK_Sb_planinfoActivity_ViewBinding(final HK_Sb_planinfoActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    HK_Sb_planinfoActivity target = this.target;
